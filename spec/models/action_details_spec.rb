...
# Unit tests for ComposioRuby::ActionDetails
describe ComposioRuby::ActionDetails do
  let(:instance) { ComposioRuby::ActionDetails.new }

  describe 'test an instance of ActionDetails' do
    it 'should create an instance of ActionDetails' do
      expect(instance).to be_instance_of(ComposioRuby::ActionDetails)
    end
  end
