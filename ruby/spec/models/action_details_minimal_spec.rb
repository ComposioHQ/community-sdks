...
# Unit tests for ComposioRuby::ActionDetailsMinimal
describe ComposioRuby::ActionDetailsMinimal do
  let(:instance) { ComposioRuby::ActionDetailsMinimal.new }

  describe 'test an instance of ActionDetailsMinimal' do
    it 'should create an instance of ActionDetailsMinimal' do
      expect(instance).to be_instance_of(ComposioRuby::ActionDetailsMinimal)
    end
  end
