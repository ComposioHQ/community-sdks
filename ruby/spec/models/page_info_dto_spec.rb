...
# Unit tests for ComposioRuby::PageInfoDTO
describe ComposioRuby::PageInfoDTO do
  let(:instance) { ComposioRuby::PageInfoDTO.new }

  describe 'test an instance of PageInfoDTO' do
    it 'should create an instance of PageInfoDTO' do
      expect(instance).to be_instance_of(ComposioRuby::PageInfoDTO)
    end
  end
