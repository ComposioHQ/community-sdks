...
# Unit tests for ComposioRuby::AppInfoResponseDto
describe ComposioRuby::AppInfoResponseDto do
  let(:instance) { ComposioRuby::AppInfoResponseDto.new }

  describe 'test an instance of AppInfoResponseDto' do
    it 'should create an instance of AppInfoResponseDto' do
      expect(instance).to be_instance_of(ComposioRuby::AppInfoResponseDto)
    end
  end
